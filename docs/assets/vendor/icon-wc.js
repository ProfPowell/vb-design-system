function u({basePath:o,set:n,name:e}){return`${o}/${n}/${e}.svg`}function h(o,n=document){let e=o.getAttribute("data-icon-set");if(e)return e;let t=o.closest("[data-icon-set]")?.getAttribute("data-icon-set");return t||n.documentElement.dataset.iconSet||"lucide"}function m(o=document){return o.documentElement.dataset.iconPath||"/vb-design-system/cdn/icons"}function l(o){let n=o.getAttribute("data-icon");if(!n){o.style.removeProperty("--vb-icon");return}let e=u({basePath:m(document),set:h(o,document),name:n});o.style.setProperty("--vb-icon",`url("${e}")`)}function a(o=document){for(let n of o.querySelectorAll("[data-icon]"))l(n)}var f=!1;function y(){if(f)return;f=!0,a(),new MutationObserver(n=>{for(let e of n)if(e.type==="attributes"){let t=e.target;t.hasAttribute&&t.hasAttribute("data-icon")&&l(t),e.attributeName==="data-icon-set"&&a(t)}else for(let t of e.addedNodes){if(t.nodeType!==1)continue;let i=t;i.hasAttribute("data-icon")&&l(i),a(i)}}).observe(document.documentElement,{subtree:!0,childList:!0,attributes:!0,attributeFilter:["data-icon","data-icon-set"]})}typeof document<"u"&&y();var b=`
:host {
  display: inline-flex;
  align-items: center;
